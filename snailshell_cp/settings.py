...
ENV = _AttrDict(
    ...
    CONTROL_PANEL_CELERY_MAIN_CONTAINER_NAME=env.str('CONTROL_PANEL_CELERY_MAIN_CONTAINER_NAME'),  # noqa
    CONTROL_PANEL_CELERY_SERVICE_CONTAINER_NAME=env.str('CONTROL_PANEL_CELERY_SERVICE_CONTAINER_NAME'),  # noqa
    ...
    CONTROL_PANEL_DEFAULT_DEPLOY_KEY=env.str('CONTROL_PANEL_DEFAULT_DEPLOY_KEY'),
    ...
    DOCKERHUB_USER=env.str('DOCKERHUB_USER'),
    DOCKERHUB_PASSWORD=env.str('DOCKERHUB_PASSWORD'),
    SECRET_KEY=env.str('SECRET_KEY'),
    DEBUG=env.bool('DEBUG', default=False),
)

# Django needs it to be here:
DEBUG = ENV.DEBUG
...
DATABASES = {
    'default': {
        ...
        'NAME': ENV.POSTGRES_DBNAME_CONTROL_PANEL,
...
BROKER_URL = f'amqp://{ENV.RABBITMQ_USER}:{ENV.RABBITMQ_PASSWORD}@{ENV.MASTER_HOST}:{ENV.RABBITMQ_PORT}//'
BROKER_TRANSPORT_OPTIONS = {'confirm_publish': False}
BROKER_HEARTBEAT = 10
CELERY_ACCEPT_CONTENT = ['json']
CELERY_TASK_SERIALIZER = 'json'
CELERY_ROUTES = {
    'snailshell_cp.deploy_container': {'queue': 'snailshell_cp_main'},
    'snailshell_cp.self_update': {'queue': 'snailshell_cp_srv'},
}
